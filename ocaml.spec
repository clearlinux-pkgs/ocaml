...
Source0  : http://caml.inria.fr/pub/distrib/ocaml-4.04/ocaml-4.04.2.tar.xz
...
install -m0644 otherlibs/bigarray/libbigarray.a %{buildroot}/usr/lib64/ocaml/
install -m0644 otherlibs/str/str.a %{buildroot}/usr/lib64/ocaml/
install -m0644 otherlibs/str/libcamlstr.a %{buildroot}/usr/lib64/ocaml/
